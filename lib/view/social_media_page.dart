...
class _SocialMediaPageState extends State<SocialMediaPage> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _isEditing
                ? _buildEditableField(_linkedInController, Icons.link, 'LinkedIn URL', 'Enter your LinkedIn profile link')
            ...
            _isEditing
                ? _buildEditableField(_githubController, Icons.code, 'GitHub URL', 'Enter your GitHub profile link')
            ...
            _isEditing
                ? _buildEditableField(_portfolioController, Icons.web, 'Portfolio URL', 'Enter your portfolio link')
  ...
  Widget _buildEditableField(TextEditingController controller, IconData icon, String label, String hint) {
    return Row(
      children: [
        GFIconButton(
          onPressed: () {},
